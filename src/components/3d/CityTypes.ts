...
export const MANHATTAN_WEATHER_ZONES: WeatherZone[] = [
  ...
  {
    id: 'zone_chinatown',
    name: 'Chinatown & F.E.A.S.T.',
    district: 'East Manhattan',
    weather: 'clear',
    center: [140, -130],
    radius: 90,
    color: '#ef4444',
    radarColor: 'rgba(239, 68, 68, 0.22)',
    description: 'Vibrant lantern lit avenues and rooftop community gardens',
  },
  {
    id: 'zone_hellskitchen',
    name: "Hell's Kitchen & Hudson Yards",
    district: 'West Manhattan',
    weather: 'rain',
    center: [-140, 130],
    radius: 90,
    color: '#8b5cf6',
    radarColor: 'rgba(139, 92, 246, 0.22)',
    description: 'Foggy industrial rail yards and neon rooftop alleys',
  },
];
