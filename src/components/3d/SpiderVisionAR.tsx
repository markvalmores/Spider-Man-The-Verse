...
export const MANHATTAN_POIS: ARPointOfInterest[] = [
  ...
  },
  {
    ...
    type: 'landmark',
    position: [-160, 135, -160],
    color: '#ea580c',
    icon: '🏛️',
    desc: '86th Floor Observation Deck & Lightning Spire',
  },
  {
    id: 'poi_feast',
    name: 'F.E.A.S.T. Community Shelter',
    type: 'landmark',
    position: [160, 35, -160],
    color: '#10b981',
    icon: '🏮',
    desc: 'Aunt May Shelter & Rooftop Greenhouse',
  },
  {
    id: 'poi_nelson_murdock',
    name: 'Nelson & Murdock Law Office',
    type: 'landmark',
    position: [-160, 30, 160],
    color: '#dc2626',
    icon: '⚖️',
    desc: "Hell's Kitchen Brownstone & Rooftop Perch",
  },
  {
    id: 'poi_times_sq',
    name: 'Times Square',
  ...
  {
    id: 'poi_subway_herald',
    name: 'Subway: 34th St Herald Sq',
    type: 'subway',
    position: [-160, 1, -140],
    color: '#ea580c',
    icon: '🚇',
    desc: 'Empire State Transit Hub',
  },
  {
    id: 'poi_subway_canal',
    name: 'Subway: Canal St Chinatown',
    type: 'subway',
    position: [160, 1, -140],
    color: '#dc2626',
    icon: '🚇',
    desc: 'Chinatown & East Side Subway Connection',
  },
  {
    id: 'poi_subway_hudson',
    name: "Subway: Hudson Yards / Hell's Kitchen",
    type: 'subway',
    position: [-160, 1, 140],
    color: '#8b5cf6',
    icon: '🚇',
    desc: 'West Side Rail Transit Station',
  },
];
